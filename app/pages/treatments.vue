...
async function loadData() {
  ...
  const [plansRes, patientRes, staffRes] = await Promise.all([
    supabase
  ...
  plans.value = (plansRes.data ?? []) as typeof plans.value
        ...
        <DialogContent class="max-h-[90vh] overflow-y-auto sm:max-w-lg">
          ...
          <form class="space-y-4" @submit.prevent="createPlan">
            ...
            <DialogFooter>
              ...
              <Button
                type="submit"
                :disabled="isSubmitting || !newPlan.patient_id || !newPlan.name"
              >
